      ...
      <div className="flex-grow">
        ...
        <div className="flex-grow">
          <div className="flex justify-center mt-4">
            <h1 className="text-2xl font-bold text-custom-green-2">Histórico de Campeonatos</h1>
          </div>
          ...
          <div className="flex flex-col items-center mt-10 w-5/6 mx-auto">
            {campeonatos.length === 0 ? (
              <p className="text-center text-xl">Nenhum campeonato encontrado no histórico.</p>
            ) : (
